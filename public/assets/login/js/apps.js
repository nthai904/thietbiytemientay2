...
$(document).ready(function() {
    ...
    if ($(".submit-check").length) {
        $(".submit-check").click(function() {
            ...
            if (slugsInValid.length || slugsError.length) {
                ...
                /* Scroll to error */
                setTimeout(function() {
                    $("html,body").animate({ scrollTop: slugOffset.offset().top - 40 },
                        "medium"
                    );
                }, 500);
                ...
                if (cardOffset) {
                    setTimeout(function() {
                        $("html,body").animate({ scrollTop: cardOffset.offset().top - 100 },
                            "medium"
                        );
                    }, 500);
                }
    ...
    if ($("#filer-gallery").length) {
        $("#filer-gallery").filer({
            ...
            changeInput: '<div class="jFiler-input-dragDrop"><div class="jFiler-input-inner"><div class="jFiler-input-icon"><i class="icon-jfi-cloud-up-o"></i></div><div class="jFiler-input-text"><h3>' +
    ...
    if ($("#filer-import").length) {
        $("#filer-import").filer({
            ...
            changeInput: '<a class="jFiler-input-choose-btn border-primary btn btn-sm bg-gradient-primary text-white mb-3"><i class="fas fa-cloud-upload-alt mr-2"></i>' +
                LANG["uploadhinhanh"] +
                "</a>",
            theme: "default",
            showThumbs: true,
            ...
            captions: {
                ...
                removeConfirmation: LANG["banmuonloaibohinhanhnay"],
                errors: {
                    filesLimit: LANG["chiduocuploadmoilan"] + " {{fi-limit}} " + LANG["hinhanh"],
                    filesType: LANG["chihotrotaptinlahinhanhcodinhdang"] + ": {{fi-extensions}}",
                    filesSize: LANG["hinhanh"] +
                        " {{fi-name}} " +
                        LANG["cokichthuocqualonvuilonguploadhinhanhcokichthuoctoida"] +
