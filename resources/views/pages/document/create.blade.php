                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label for="manhathau">Nhà thầu</label>
                                            <select name="id_nhathau" id="select-nha-thau" class="select2 form-control">
                                                <option value="" disabled selected>-- Chọn nhà thầu --</option>
                                                @if (isset($categories))
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <input type="number" class="form-control border-primary"
                                                                title="Nhập giá chênh lệch" value="" id="extra-price" name="extra_price"> 
                                                        </td>
                                                        <td id="nt-giaduthau"></td>
                                                        <input type="hidden" value="" id="input-giaduthau" name="giaduthau">
                                                        <td id="total"></td>
                                                        <input type="hidden" value="" id="input-total" name="thanhtien">
                                                    </tr>
                                                </tbody>
                                            </table>
                                        </div>
