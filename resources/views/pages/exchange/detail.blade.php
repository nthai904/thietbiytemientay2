                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <select
                                                class="select2 form-control no-click" tabindex="-1">
                                                            ...
                                                            @foreach ($documents as $k => $v)
                                                                <tr class="{{ $v->extra_price < 0 ? 'bg-red' : ''}}">
                                                                    ...
                                                                    <td><input type="number"
                                                                            ...
                                                                            name="so_luong[]" value="{{ $v->quantity }}" id="nt-soluong">
                                                                    </td>
                                                                    ...
                                                                    <td class="exchange-price">
                                                                        {{ number_format($v->price, 0, ',', '.') }} đ</td>
                                                                    <input type="hidden" name="exchange_price[]"
                                                                        class="input-exchange-price" value="{{$v->price}}">
                                                                    <td class="total">
                                                                        {{ number_format($v->total_price, 0, ',', '.') }} đ
                                                                    </td>
                                                                    <input type="hidden" name="thanhtien[]"
                                                                        class="input-total" value="{{$v->total_price}}">
