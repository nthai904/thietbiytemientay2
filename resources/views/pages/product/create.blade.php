    ...
    <div class="container">
        <div class="page-inner">
            <div class="page-header">
                <h3 class="fw-bold mb-3">Thêm mới hàng hóa</h3>
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="ky_ma_hieu" name="ky_ma_hieu"
                                                placeholder="Nhập ký mã hiệu" value="{{ old('ky_ma_hieu') }}">
                                        </div>
                                    </div>
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="hang_sx" name="hang_sx"
                                                placeholder="Nhập hãng sản xuất" value="{{ old('hang_sx') }}">
                                        </div>
                                    </div>
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="nuoc_sx" name="nuoc_sx"
                                                placeholder="Nhập nước sản xuất" value="{{ old('nuoc_sx') }}">
                                        </div>
                                    </div>
                                    {{-- <div class="col-md-6">
                                        <div class="row">
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="quy_cach" name="quy_cach"
                                                placeholder="Nhập quy cách đóng gói" value="{{ old('quy_cach') }}">
                                        </div>
                                    </div>
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="don_vi_tinh" name="don_vi_tinh"
                                                placeholder="Nhập tên đại diện" value="{{ old('don_vi_tinh') }}">
                                        </div>
                                    </div>
                                    <div class="col-md-3">
                                        <div class="form-group">
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <input type="number" class="form-control" id="gia_von" name="gia_von"
                                                placeholder="Nhập giá vốn" value="{{ old('gia_von') }}">
                                        </div>
                                    </div>
                                    <div class="col-md-3">
                                        <div class="form-group">
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="ten_ncc" name="ten_ncc"
                                                placeholder="Nhập tên ncc" value="{{ old('ten_ncc') }}">
                                        </div>
                                    </div>
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="ma_vtyt" name="ma_vtyt"
                                                placeholder="Nhập mã VTYT dùng chung" value="{{ old('ma_vtyt') }}">
                                        </div>
                                    </div>
                                    <div class="col-md-3">
                                        <div class="form-group">
