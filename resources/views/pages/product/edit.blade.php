                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="name" name="name"
                                                placeholder="Nhập tên hàng hóa" value="{{ $product->name }}">
                                        </div>
                                    </div>
                                    <div class="col-md-3">
                                        <div class="form-group">
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="hang_nuoc_chu_so_huu"
                                                ...
                                                value="{{ $product->hang_nuoc_chu_so_huu }}">
                                        </div>
                                    </div>
                                    <div class="col-md-3">
                                        <div class="form-group">
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="so_dang_ky_luu_hanh"
                                                ...
                                                value="{{ $product->so_dang_ky_luu_hanh }}">
                                        </div>
                                    </div>
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="so_bang_phan_loai"
                                                ...
                                                value="{{ $product->so_bang_phan_loai }}">
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="thong_so_ky_thuat_co_ban">Đặc tính thông số kỹ thuật cơ bản</label>
                                            <textarea name="thong_so_ky_thuat_co_ban" id="thong_so_ky_thuat_co_ban" cols="30" rows="10"
                                                class="form-control product-description">{{ $product->thong_so_ky_thuat_co_ban }}</textarea>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="thong_so_ky_thuat_thau">Đặc tính thông số kỹ thuật thầu</label>
                                            <textarea name="thong_so_ky_thuat_thau" id="thong_so_ky_thuat_thau" cols="30" rows="10"
                                                class="form-control product-description">{{ $product->thong_so_ky_thuat_thau }}</textarea>
                                        </div>
                                    </div>
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <label for="ghi_chu">Ghi chú</label>
                                            <textarea name="ghi_chu" id="ghi_chu" cols="30" rows="12" class="form-control">{{ $product->ghi_chu }}</textarea>
                                        </div>
                                    </div>
                                    {{-- <div class="col-md-3">
                                        <div class="form-group">
