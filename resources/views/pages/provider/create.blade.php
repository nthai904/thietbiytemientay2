                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="address" name="address"
                                                placeholder="Nhập tên hàng hóa" value="{{ old('address') }}">
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="represent" name="represent"
                                                placeholder="Nhập người đại diện" value="{{ old('represent') }}">
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label for="phone1">Số điện thoại 1 <span class="text-red">*</span></label>
                                                    <input type="number" class="form-control no-spinner" id="phone1" name="phone1"
                                                        placeholder="Nhập số điện thoại" value="{{ old('phone1') }}">
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label for="phone2">Số điện thoại 2</label>
                                                    <input type="number" class="form-control no-spinner" id="phone2" name="phone2"
                                                        placeholder="Nhập số điện thoại" value="{{ old('phone2') }}">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <textarea name="note" id="note" cols="30" rows="8" class="form-control">{{ old('note') }}</textarea>
                                        </div>
                                    </div>
                                    {{-- <div class="col-md-3">
                                        <div class="form-group">
